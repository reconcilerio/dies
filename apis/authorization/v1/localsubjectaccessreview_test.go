...
func TestLocalSubjectAccessReview(t *testing.T) {
	tests := []struct {
		name     string
		die      *dieauthorizationv1.LocalSubjectAccessReviewDie
		expected authorizationv1.LocalSubjectAccessReview
	}{
		{
			name:     "empty",
			die:      dieauthorizationv1.LocalSubjectAccessReviewBlank,
			expected: authorizationv1.LocalSubjectAccessReview{},
		},
		{
